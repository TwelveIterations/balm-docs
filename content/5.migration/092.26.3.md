...
This method was only used to fire an event on Forge. There is no direct replacement. If you have need for this, you can define a bidirectional event mapper or use a platform proxy.

### Removed `BalmCompostableRegistrar`

Minecraft uses a Data Component `Compostable` that you should use now.
