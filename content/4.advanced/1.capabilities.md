...
:::warning[Caveat: Capabilities on Forge 26.1+]
On Forge 26.1, registration on Forge is only possible with a Forge-specific annotation. See below for more.
:::

:::warning[Caveat: Capabilities on Forge before 26.1]
On Forge before 26.1, there is some additional code required to register a capability. See below for more.
:::
