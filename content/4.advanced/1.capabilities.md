...
- The `FluidTank` capability is exposed as `IFluidHandler` on Forge and NeoForge, and as `FluidStorage` on Fabric
...
```java
public class YourStorageBlockEntity extends BlockEntity implements BalmContainerProvider {
    // ...
    @Override
