...
You can obtain a `BalmRecipeTypeRegistrar` through the `BalmRegistrars` instance passed to your mod initializer, or by registering your mod as a `BalmModule`.
