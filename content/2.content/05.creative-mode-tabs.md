...
You can obtain a `BalmCreativeModeTabRegistrar` through the `BalmRegistrars` instance passed to your mod initializer, or by registering your mod as a `BalmModule`.
...
public class YourMod {
    ...
    public static void initialize(BalmRegistrars registrars) {
        registrars.creativeModeTabs(ModCreativeModeTabs::initialize);
    }
